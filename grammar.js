...
module.exports = grammar({
  ...
  rules: {
    ...
    array_rank_specifier: ($) =>
      seq("[", commaSep(optional($.expression_)), "]"),
    ...
    case_pattern_switch_label: ($) =>
      seq("case", $.pattern_, optional($.when_clause), ":"),
    ...
    await_expression: ($) =>
      prec.right(PREC.UNARY, seq("await", $.expression_)),
    ...
    with_initializer_expression: ($) =>
      commaSep1($.simple_assignment_expression),
